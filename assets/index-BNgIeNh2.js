(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&n(s)}).observe(document,{childList:!0,subtree:!0});function r(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(t){if(t.ep)return;t.ep=!0;const o=r(t);fetch(t.href,o)}})();const d=()=>`
  ...
  `,y=e=>`
    <article class="container" style="padding-top: 2rem; padding-bottom: 4rem; max-width: 800px; animation: fadeIn 0.5s ease;">
      ...
      <div style="height: 400px; background: ${e.imageColor}; border-radius: 1rem; margin-bottom: 3rem; position: relative; overflow: hidden;">
         <div style="position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.5), transparent);"></div>
      </div>

      <div class="prose" style="font-size: 1.1rem; line-height: 1.8; color: var(--color-text-primary);">
        <p style="margin-bottom: 1.5rem;">${e.excerpt}</p>
  ...
  `,f=e=>{const i=m.find(r=>r.id===parseInt(e));return i?`
    ...
    ${y(i)}
    ${c()}
  `:p()},l=()=>{const e=document.querySelector("#app");a.view==="home"?e.innerHTML=p():a.view==="detail"&&(e.innerHTML=f(a.postId)),h()},h=()=>{document.querySelectorAll('a[href="#"]').forEach(r=>{r.addEventListener("click",n=>n.preventDefault())}),document.querySelectorAll(".post-link").forEach(r=>{r.addEventListener("click",n=>{const t=r.dataset.id;a.view="detail",a.postId=t,window.scrollTo(0,0),l()})});const e=document.getElementById("back-home");e&&e.addEventListener("click",r=>{r.preventDefault(),a.view="home",a.postId=null,window.scrollTo(0,0),l()});const i=document.querySelector('header a[href="/"]');i&&i.addEventListener("click",r=>{r.preventDefault(),a.view="home",l()})};l();
